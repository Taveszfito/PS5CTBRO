...
Most of these features are **not natively supported on Android**, so the app uses custom / workaround solutions.
...
This project is not affiliated with or endorsed by Sony or PlayStation.
...
This app is an attempt to experiment, learn, and push those limits a bit further.
